...
public:
  ...
  char GetChar(); // Read a character from console, waiting if necessary
  int GetInt(); // Get a character from console, waiting if necessary
  void GetString(char * buffer, int length);// Get a string from console, waiting if necessary
  int Read(char *buffer, int numBytes); // Read synch line
private:
...
public:
  ...
  void PutChar(char ch); // Write a character to console, waiting if necessary
  void PutInt(int n); //Write an integer to console, waiting if necessary
  void PutString(char* buffer); //Write a string to console, waiting if necessary
